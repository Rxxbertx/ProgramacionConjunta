...
public class MainOperaciones {
	...
	public static void main(String[] args) {
		 ...
		 * mientras el número sea negativo. ➢ 
		 * Crea un objeto de la clase Operaciones y
		...
		operaciones.pedirEntero(sc);
		
		System.out.println("La suma de " + operaciones.getNumero1() + " y " + operaciones.getNumero2() + " es: " + operaciones.sumar());
		System.out.println("La división de " + operaciones.getNumero1() + " entre " + operaciones.getNumero2() + " es: " + operaciones.dividir());
